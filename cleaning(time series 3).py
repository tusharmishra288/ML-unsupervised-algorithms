...
# detrend the data
detrended = sm.tsa.tsatools.detrend(riverFlows, order=1, axis=0)

# updating riverFlows dataframe with detrended data 
riverFlows['american_flow_d'] = detrended['american_flow']
riverFlows['columbia_flow_d'] = detrended['columbia_flow']
...
with open(data_folder + 'output/combined_flow_d1.csv', 'w') as o:
...
#print(riverFlows['american_flow_t'])
...
# save the chart
plt.savefig(data_folder + 'output/detrended.png', dpi=300)
